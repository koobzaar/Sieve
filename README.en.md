<p align="right">
  <a href="README.md"><img src="https://img.shields.io/badge/PT--BR-Português-6C757D?style=flat-square" alt="Português (Brasil)" /></a>
  <a href="README.en.md"><img src="https://img.shields.io/badge/EN-English-1F6FEB?style=flat-square" alt="English" /></a>
</p>
...
checks both private chat and sender IDs before Gemini sees a message. The accessible interface is
available in English and Brazilian Portuguese, remembers the selection in SQLite, uses descriptive
HTML screens and buttons, and paginates long preference lists. Deterministic commands are:
